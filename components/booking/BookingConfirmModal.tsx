      ...
      <div className="w-full bg-slate-900 rounded-t-3xl p-6 border-t border-slate-700 max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full py-4 px-6 bg-[#ff016e] text-white text-lg font-bold rounded-xl transition-all hover:bg-[#e6015f] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed shadow-xl shadow-[#ff016e]/30 flex items-center justify-center gap-2"
          >
            {isLoading && (
